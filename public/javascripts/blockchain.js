...
contractInstance = VotingContract.at('0xFdE00D523Bb4C5Db567B19fC16aa92197E21B8c4');
...
function voteForCandidate(id) {
  ...
  //var candidateName = document.getElementById(id);
  ...
  var voteflag = confirm(candidateName);
